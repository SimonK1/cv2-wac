...
import { SkAmbulanceWlEditor } from '../sk-ambulance-wl-editor';
...
describe('sk-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [SkAmbulanceWlEditor],
      html: `<sk-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></sk-ambulance-wl-editor>`,
    });
