...
@Component({
  tag: 'sk-ambulance-wl-editor',
  styleUrl: 'sk-ambulance-wl-editor.css',
  shadow: true,
})
export class SkAmbulanceWlEditor {
  @Prop() entryId: string;
...
render() {
  ...
  return (
    <Host>
      ...
      <md-filled-text-field label="Čakáte od"value={this.entry?.waitingSince} disabled>
